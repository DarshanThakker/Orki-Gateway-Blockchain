...
// // //       const [merchantPda] = helper.getMerchantPda(merchantOwner.publicKey, merchantName);
...
// // //         assert.fail("Should have failed");
// // //       } catch (e: any) {
// // //         assert.ok(e.message.includes("NameTooLong"));
// // //       }
// // //     });
// // //   });
...
// // //       const newMerchantPda = helper.getMerchantPda(merchantOwner.publicKey, newName);
...
// // //         assert.fail("Should have failed");
// // //       } catch (e: any) {
// // //         assert.ok(e.message.includes("has_one"));
// // //       }
// // //     });
// // //   });
// // // });
...
// //     it("should fail if merchant name is too long", async () => {
// //       const longName = "a".repeat(33); // Max is 32
// //       const [longMerchantPda] = helper.getMerchantPda(merchantOwner.publicKey, longName); // Extract PublicKey

// //       try {
// //         await program.methods
// //           .registerMerchant(merchantWallet.publicKey, PublicKey.default, longName)
// //           .accountsStrict({
// //             merchant: longMerchantPda, // Use extracted PublicKey
// //             owner: merchantOwner.publicKey,
// //             systemProgram: SystemProgram.programId,
// //           })
// //           .signers([merchantOwner])
